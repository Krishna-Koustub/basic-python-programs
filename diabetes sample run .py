...
df = pd.read_csv("http://archive.ics.uci.edu/ml/machine-learning-databases/pima-indians-diabetes/notePimaIndians.txt")
#-------------------

#defining the columns
df.columns =['No_pregnant', 'Plasma_gnotePimaIndians.txtlucose', 'Blood_pres', 'Skin_thick',
